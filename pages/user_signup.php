...
<body>
    <div class="auth-container">
        <div class="auth-card" style="max-width: 500px;">
            ...
            <form action="auth/user_signup_process.php" method="POST" onsubmit="return validateSignupForm(this)">
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="email" class="form-control" placeholder="User" required>
                </div>
                
                <div class="form-group">
                    <label class="form-label">Password</label>
                    <input type="password" name="password" class="form-control" placeholder="User" required>
                </div>
