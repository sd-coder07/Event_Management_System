...
<body>
    <div class="auth-container">
        <div class="auth-card">
            ...
            <form action="auth/user_login_process.php" method="POST" onsubmit="return validateLoginForm(this)">
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="password" class="form-control" placeholder="User">
                </div>
            ...
            <div style="text-align: center; margin-top: 20px; padding-top: 20px; border-top: 1px solid #ddd;">
                ...
                <a href="user_signup.php" class="btn btn-success">Sign Up</a>
            </div>
        </div>
    </div>
