...
<body>
    <div class="auth-container">
        <div class="auth-card">
            ...
            <form action="auth/admin_login_process.php" method="POST" onsubmit="return validateLoginForm(this)">
                <div class="form-group">
                    <label class="form-label">User Id</label>
                    <input type="text" name="user_id" class="form-control" placeholder="Admin" value="Admin">
                </div>
            ...
            <div style="text-align: center; margin-top: 20px; padding-top: 20px; border-top: 1px solid #ddd;">
                <a href="../index.php" style="color: #4a7fc1; text-decoration: none;">Back to Home</a>
            </div>
        </div>
    </div>
